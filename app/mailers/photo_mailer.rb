class PhotoMailer < ApplicationMailer
	...
	def email_photo(pid)
		begin
			...
			#InstaPrinter1
			mg_obj.add_recipient(:to, "instaprinter1@print.epsonconnect.com");
									   
			#InstaPrinter2
			#mg_obj.add_recipient(:to, "instaprinter2@print.epsonconnect.com");  
			...
			resp = s3.get_object(bucket:'instaprinter1', key:pid + '_print.jpg')
